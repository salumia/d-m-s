...
Route::group(['middleware' => 'api', 'prefix' => 'api', 'namespace' => 'Modules\Contract\Http\Controllers'], function()
{
	...
	Route::get('category-list', 'CategoriesController@getCategoryArray');
	Route::get('category-list/{user}', 'CategoriesController@getIndustryCategoryArray');
    ...
    Route::get('industry-list', 'IndustriesController@getIndustryArray');  
